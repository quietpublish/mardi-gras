#!/bin/bash
# Shared vhs capture runner: builds mg + the fake supervisor, starts fakegc,
# drives mg through the given tape, and reports what was written.
# Usage: ./testdata/run-vhs.sh <tape-path> <wrote-message>
